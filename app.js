...
(function () {
  ...
  var MATCH_RATINGS = {
    ...
    // CAN-BIH 평점(사진, SofaScore) — 캐나다 6.75 / 보스니아 6.88. 크레포·코넬리우스는 사진 흐려 추정(6.7).
    "match-7": {
      team: { "canada": 6.75, "bosnia-and-herzegovina": 6.88 },
      byName: {
        "막심 크레포": 6.7, "알리스테어 존스턴": 7.2, "뤽 드 푸제롤": 7.5, "데릭 코넬리우스": 6.7, "리치 라리에아": 7.8, "타종 뷰캐넌": 6.2, "이스마엘 코네": 6.6, "스테판 에우스타키오": 7.1, "리암 밀러": 5.8, "조나단 데이비드": 6.3, "타니 올루와세이": 6.2,
        "알리 아흐메드": 6.6, "제이콥 섀펄버그": 6.7, "프로미스 데이비드": 6.5, "사일 라린": 7.6,
        "니콜라 바실리": 6.3, "아마르 메미치": 6.3, "이반 바시치": 7.4, "벤야민 타히로비치": 6.5, "에스미르 바이락타레비치": 6.1, "세아드 콜라시나츠": 8.0, "타리크 무하레모비치": 7.7, "니콜라 카티치": 6.1, "아마르 데디치": 7.4, "요보 루키치": 7.5, "에르메딘 데미로비치": 6.6,
        "아르민 기고비치": 6.7, "사메드 바즈다르": 6.2, "이반 슌이치": 6.4, "제니스 부르니치": 6.7
      }
    }
  };
