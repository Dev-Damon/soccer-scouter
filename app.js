  ...
  var MATCH_RATINGS = {
    ...
    "match-44": {  // 사우디아라비아-우루과이
      ...
      byName: {
        ...
        "세바스티안 카세레스": 6.6, "마누엘 우가르테": 8.3, "로드리고 벤탄쿠르": 8.5, "니콜라스 데 라 크루스": 6.9, "페데리코 발베르데": 8.4, "다르윈 누녜스": 8.4, "기예르모 바렐라": 6.7, "아구스틴 카노비오": 6.5, "마티아스 올리베라": 7.2, "마티아스 비냐": 8.2, "브라이안 로드리게스": 6.6, "막시밀리아노 아라우호": 7.4, "페데리코 비냐스": 8.5, "페르난도 무슬레라": 6.4, "후안 마누엘 사나브리아": 6.9
      }
    },
    "match-31": {  // 네덜란드-일본
  ...
  function matchStatsHtml(a, b, bs, live) {
    ...
    var rows = STAT_DEFS.map(function (d) {
      ...
      if (d.split) {
        ...
        bar = '<div class="ms-bar mr"><span class="ms-h l"><i style="width:' + pa + '%"></i></span><span class="ms-h r"><i style="width:' + pb + '%"></i></span></div>';
      } else {
