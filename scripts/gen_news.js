...
const ARTICLES = [
  ...
  { slug: "how-to-watch", title: "2026 북중미 월드컵 중계 보는 법 — TV·모바일·무료 시청 총정리", desc: "2026 월드컵 국내 중계 총정리. TV는 KBS·JTBC, 모바일 생중계는 치지직, OTT 다시보기와 무료로 보는 방법·하이라이트까지 한눈에." },
  { slug: "soccer-basics", title: "축구 규칙 기초 — 처음 보는 사람을 위한 완전 입문", desc: "11명 대 11명, 득점 방법, 경기 시간, 스로인·골킥·코너킥, 오프사이드·파울·페널티킥까지 축구를 처음 보는 사람을 위한 기초 규칙 총정리." },
  { slug: "fifa-ranking", title: "FIFA 랭킹이란? 순위 산정 방식과 의미 완전 정리", desc: "FIFA 랭킹이 무엇이고 어떻게 오르내리는지(엘로 방식·상대 강약·대회 중요도), 월드컵 조 추첨 시드로 쓰이는 이유까지 정리했다." },
  { slug: "golden-boot-history", title: "역대 월드컵 득점왕·최다 득점 기록 총정리", desc: "통산 최다 클로제 16골, 단일 대회 최다 퐁텐 13골(1958), 호나우두·게르트 뮐러 등 역대 월드컵 득점왕과 최다 득점 기록을 정리했다." },
  { slug: "korea-worldcup-history", title: "대한민국 역대 월드컵 성적 총정리 — 2002 4강부터 카타르 16강까지", desc: "2002 4강 신화, 2010 첫 원정 16강, 2018 독일전 2-0, 2022 카타르 16강까지 대한민국의 역대 월드컵 성적과 명장면을 정리했다." },
  { slug: "tactics-deep", title: "축구 전술 완전 정리 — 압박·빌드업·역습·점유율 한눈에", desc: "점유율 vs 역습, 전방 압박·게겐프레싱, 빌드업, 수비 라인과 오프사이드 트랩까지 축구 전술의 핵심 개념을 한눈에 정리했다." },
  { slug: "goalkeeper-guide", title: "골키퍼 완전 정리 — 역할과 규칙, 현대 GK의 조건", desc: "골키퍼의 백패스 룰·6초 룰·페널티킥 위치 규칙과 빌드업을 여는 스위퍼 키퍼 등 현대 골키퍼의 역할, 평가 지표까지 정리했다." },
  { slug: "football-derby", title: "축구 더비란? 세계의 라이벌전과 그 열기", desc: "엘 클라시코·수페르클라시코·북런던 더비 등 세계의 라이벌전과, 더비가 순위와 무관하게 뜨거운 이유를 정리했다." },
  { slug: "a-match", title: "A매치란? 국가대표 경기와 평가전 완전 정리", desc: "A매치의 뜻과 평가전·예선·본선의 차이, A매치 데이에 리그가 멈추는 이유와 소집·차출, FIFA 랭킹과의 관계까지 정리했다." },
  { slug: "install-guide", title: "킥톡 앱 설치·사용법 — 홈 화면에 추가하고 월드컵 100% 즐기기", desc: "킥톡을 아이폰·안드로이드 홈 화면에 앱처럼 추가하는 법과 실시간 스코어·라인업·평점·대진표·스포일러 방지 모드 등 핵심 기능 활용법을 정리했다." },
  { slug: "leagues-guide", title: "세계 축구 리그 완전 정리 — 유럽 5대 리그부터 K리그까지", desc: "프리미어리그·라리가·분데스리가·세리에A·리그1 유럽 5대 리그와 MLS·K리그·J리그, 챔피언스리그까지 세계 축구 리그를 한눈에 정리했다." },
  { slug: "continental-cups", title: "대륙별 축구 대회 완전 정리 — 유로·코파아메리카·아시안컵", desc: "유로·코파 아메리카·AFC 아시안컵·아프리카 네이션스컵·골드컵 등 대륙 선수권과 월드컵 예선·진출권의 관계를 정리했다." },
  { slug: "soccer-field", title: "축구 경기장 완전 정리 — 규격과 구역, 골대 크기까지", desc: "경기장 크기, 센터서클·페널티 박스·골 에어리어·페널티 마크 등 각 구역의 의미와 골대(7.32×2.44m) 규격까지 축구 경기장 구조를 정리했다." },
  { slug: "host-cities-2026", title: "2026 월드컵 개최지 총정리 — 미국·캐나다·멕시코 16개 도시", desc: "미국 11·멕시코 3·캐나다 2, 총 16개 개최 도시와 경기장, 멕시코시티 개막전·뉴욕 결승 등 2026 북중미 월드컵 개최지를 정리했다." },
];
