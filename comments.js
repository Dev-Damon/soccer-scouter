...
(function () {
  ...
  var BADWORDS = [
    // 욕설
    "시발", "씨발", "씨바", "시바", "씨팔", "시팔", "쉬발", "씨발놈", "씨발년", "시발놈", "ㅅㅂ", "ㅆㅂ", "ㅄ", "ㅂㅅ",
    "쌍놈", "쌍년", "썅", "썅놈", "썅년",
    "개새끼", "개새", "개색", "개세끼", "개색끼", "개자식", "개씨발", "개지랄", "개소리",
    "씨발새끼", "씹새끼", "좆", "좇", "좆같", "좆나", "좆도", "조까", "조온나",
    "병신", "븅신", "빙신", "존나", "졸라", "ㅈㄴ", "ㅈㄹ",
    "니애미", "느금", "느금마", "느그애미", "엠창", "엠생", "니미",
    "씹", "씹창", "씹새", "씹할", "씹탱",
    "보지", "자지", "후장", "따먹", "꼴려", "발정", "빨아라",
    "지랄", "닥쳐", "닥치", "꺼져", "뒤져", "뒤진", "디져",
    "또라이", "등신", "미친놈", "미친년", "미친새끼",
    // 성적 표현
    "섹스", "쎅스", "섹스하", "야동", "자위", "강간", "변태", "창녀", "걸레년", "호로새끼", "호로자식",
    // 영어
    "fuck", "fuckin", "fucking", "shit", "bitch", "asshole", "nigger", "dick", "pussy", "cunt", "motherfucker"
  ];
